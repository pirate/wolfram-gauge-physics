...
- **A structural obstruction that narrows the search for energy.** For this two-link lift,
...
2. **Derive richer local dynamics.** Search beyond unary maps and the first Hurwitz exchange for
   ...
   obstruction, but the current spectator-blind pair lift cannot transport a conserved
   one-face energy. Extend primitive rule searches to the full affected neighborhood and
   derive larger-support conservation laws, rather than inserting a target energy function.
